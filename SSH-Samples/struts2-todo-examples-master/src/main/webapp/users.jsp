            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div class="btn-toolbar">
                        ...
                        <s:form action="searchCustomerAction" theme="simple" cssClass="form-inline">
                                <input name="phoneNumber" value="<s:property value="phoneNumber" />" class="input-xlarge" placeholder="Search Customer by Phone number..." id="appendedInputButton" type="text">
                                
                                <!--<button class="btn" type="button"><i class="icon-search"></i> Go</button>-->
                                <s:submit label="Search" theme="simple" cssClass="btn btn-primary"></s:submit>
                        </s:form>
                        <!--</div>-->

                        <!--<button class="btn btn-primary"><i class="icon-plus"></i> New User</button>-->
                        <a class="btn" href="newCustomerAction">
                    ...
                    <div class="well">
                                ...
                                <tbody>
                                    <s:iterator value="customerList" status="userStatus">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="customerHomeAction?uid=<s:property value="uid"/>"><s:property value="name" /></a>
                                            </td>
                                            <td><s:property value="address.street" /></td>
                                            <td><s:date name="registrationDate" format="dd/MM/yyyy" /></td>
                                            <td><s:property value="address.phoneNumber" /></td>
                                            <td>
                                                <a href="editCustomerAction?uid=<s:property value="uid"/>"><i class="icon-pencil"></i></a>
                                                <a href="deleteCustomerAction?uid=<s:property value="uid"/>"><i class="icon-remove"></i></a>
                                            </td>
                                        </tr>
                                    </s:iterator>
                                </tbody>
                        ...
                        <s:else>
                            <div class="alert">
                                ...
                                <strong>Warning!</strong> There is no regisstered customers yet.
                            </div>
                        </s:else>
                    </div>
